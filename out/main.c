...
#include <unistd.h>
#include <signal.h>
#include "/Users/veitheller/Documents/Code/Github/carp/archive/zlib/zlib_helper.h"
...
typedef struct Result__ZLibZBytes_String Result__ZLibZBytes_String;
typedef struct Result__bool_String Result__bool_String;
typedef struct TestState TestState;
typedef struct ZLibZLevel ZLibZLevel;
...
// Depth 6
typedef bool(*Fn__Result__String_String_MUL__Result__String_String_MUL__bool)(Result__String_String*, Result__String_String*);

// Depth 6
typedef String(*Fn__Result__String_String_MUL__String)(Result__String_String*);

// Depth 6
typedef bool(*Fn__Result__String_String_MUL__bool)(Result__String_String*);
...
#define ZLibZLevel_NoCompression_tag 0
#define ZLibZLevel_BestSpeed_tag 1
#define ZLibZLevel_BestCompression_tag 2
#define ZLibZLevel_DefaultCompression_tag 3
...
// Depth 504
struct Result__ZLibZBytes_String {
    union {
    struct {
        ZLibZBytes member0;
    } Success;
...
#define Result__ZLibZBytes_String_Success_tag 0
#define Result__ZLibZBytes_String_Error_tag 1
...
// Depth 505
typedef ZRes(*Fn__String_MUL__int_ZRes)(String*, int);

// Depth 505
typedef TestState(*Fn__TestState_Fn__int_int_MUL__TestState)(TestState, Lambda*);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Result__String_String_MUL__Result__String_String_MUL__String_MUL__String_MUL__Fn__Result__String_String_MUL__Result__String_String_MUL__bool_TestState)(TestState*, Result__String_String*, Result__String_String*, String*, String*, Lambda);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Result__String_String_MUL__Result__String_String_MUL__String_MUL__String_MUL__bool_TestState)(TestState*, Result__String_String*, Result__String_String*, String*, String*, bool);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Result__String_String_MUL__Result__String_String_MUL__String_MUL__TestState)(TestState*, Result__String_String*, Result__String_String*, String*);
...
// Depth 505
typedef String(*Fn__ZLibZBytes_MUL__String)(ZLibZBytes*);

// Depth 505
typedef Result__String_String(*Fn__ZLibZBytes_Result__String_String)(ZLibZBytes);

// Depth 505
typedef ZRes(*Fn__ZLibZBytes_ZRes)(ZLibZBytes);

// Depth 505
typedef String(*Fn__ZLibZLevel_MUL__String)(ZLibZLevel*);

// Depth 505
typedef int(*Fn__ZLibZLevel_int)(ZLibZLevel);

// Depth 505
typedef bool(*Fn__ZRes_MUL__bool)(ZRes*);

// Depth 505
typedef String(*Fn__ZRes_String)(ZRes);

// Depth 505
typedef ZLibZBytes(*Fn__ZRes_ZLibZBytes)(ZRes);

// Depth 505
typedef ColorId(*Fn___ColorId)();

// Depth 505
typedef ZLibZLevel(*Fn___ZLibZLevel)();

// Depth 505
typedef CChar*(*Fn__int_CChar_MUL_)(int);

// Depth 505
typedef ZLibZBytes(*Fn__int_String_ZLibZBytes)(int, String);
...
// Depth 507
typedef bool(*Fn__Result__ZLibZBytes_String_MUL__bool)(Result__ZLibZBytes_String*);

// Depth 507
typedef ZLibZBytes(*Fn__Result__ZLibZBytes_String_ZLibZBytes)(Result__ZLibZBytes_String);

// Depth 507
typedef Result__ZLibZBytes_String(*Fn__String_MUL__Result__ZLibZBytes_String)(String*);

// Depth 507
typedef Result__ZLibZBytes_String(*Fn__String_MUL__ZLibZLevel_Result__ZLibZBytes_String)(String*, ZLibZLevel);

// Depth 507
typedef Result__ZLibZBytes_String(*Fn__String_Result__ZLibZBytes_String)(String);

// Depth 507
typedef Result__ZLibZBytes_String(*Fn__ZLibZBytes_Result__ZLibZBytes_String)(ZLibZBytes);
...
// Depth 500
void Function_delete__Result__String_String_MUL__Result__String_String_MUL__bool (Lambda f);
...
// Depth 500
bool Result__EQ___String_String(Result__String_String* a, Result__String_String* b);
...
// Depth 500
Result__ZLibZBytes_String Result_Error__String_ZLibZBytes(String member0);
...
// Depth 500
Result__ZLibZBytes_String Result_Success__ZLibZBytes_String(ZLibZBytes member0);
...
// Depth 500
void Result_delete__ZLibZBytes_String(Result__ZLibZBytes_String p);
...
// Depth 500
String Result_str__String_String(Result__String_String *p);

// Depth 500
bool Result_success_QMARK___String_String(Result__String_String* a);
...
// Depth 500
bool Result_success_QMARK___ZLibZBytes_String(Result__ZLibZBytes_String* a);
...
// Depth 500
ZLibZBytes Result_unsafe_MINUS_from_MINUS_success__ZLibZBytes_String(Result__ZLibZBytes_String a);
...
// Depth 500
TestState Test_assert_MINUS_equal__Result__String_String_MUL__String(TestState* state, Result__String_String* x, Result__String_String* y, String* descr);
...
// Depth 500
TestState Test_display_MINUS_test__Result__String_String_MUL__Result__String_String_MUL__String_String(TestState* state, Result__String_String* expected, Result__String_String* actual, String* descr, String* what, bool is_MINUS_success);
...
// Depth 500
TestState Test_handler__Result__String_String_MUL__Result__String_String_MUL__String_String(TestState* state, Result__String_String* expected, Result__String_String* actual, String* descr, String* what, Lambda op);
...
// Depth 500
Result__ZLibZBytes_String ZLib_deflate(String* s);

// Depth 500
Result__ZLibZBytes_String ZLib_deflate_MINUS_with(String* s, ZLibZLevel level);

// Depth 500
Result__String_String ZLib_inflate(ZLibZBytes s);

// Depth 1000

// Depth 500
String* ZLib_ZBytes_bytes(ZLibZBytes* p);

// Depth 500
ZLibZBytes ZLib_ZBytes_init(int len, String bytes);

// Depth 500
int* ZLib_ZBytes_len(ZLibZBytes* p);

// Depth 500
String ZLib_ZBytes_prn(ZLibZBytes *p);

// Depth 500
ZLibZBytes ZLib_ZBytes_set_MINUS_bytes(ZLibZBytes p, String newValue);

// Depth 500
void ZLib_ZBytes_set_MINUS_bytes_BANG_(ZLibZBytes* pRef, String newValue);

// Depth 500
ZLibZBytes ZLib_ZBytes_set_MINUS_len(ZLibZBytes p, int newValue);

// Depth 500
void ZLib_ZBytes_set_MINUS_len_BANG_(ZLibZBytes* pRef, int newValue);

// Depth 500
String ZLib_ZBytes_str(ZLibZBytes *p);

// Depth 500
ZLibZBytes ZLib_ZBytes_update_MINUS_bytes(ZLibZBytes p, Lambda *updater);

// Depth 500
ZLibZBytes ZLib_ZBytes_update_MINUS_len(ZLibZBytes p, Lambda *updater);

// Depth 1000

// Depth 500
ZLibZLevel ZLib_ZLevel_BestCompression();

// Depth 500
ZLibZLevel ZLib_ZLevel_BestSpeed();

// Depth 500
ZLibZLevel ZLib_ZLevel_DefaultCompression();

// Depth 500
ZLibZLevel ZLib_ZLevel_NoCompression();

// Depth 500
ZLibZLevel ZLib_ZLevel_copy(ZLibZLevel* pRef);

// Depth 500
void ZLib_ZLevel_delete(ZLibZLevel p);

// Depth 500
int ZLib_ZLevel_get_MINUS_tag(ZLibZLevel *p);

// Depth 500
String ZLib_ZLevel_prn(ZLibZLevel *p);

// Depth 500
String ZLib_ZLevel_str(ZLibZLevel *p);

// Depth 500
int ZLib_ZLevel_to_MINUS_int(ZLibZLevel l);
...
bool Result__EQ___String_String(Result__String_String* a, Result__String_String* b) {
    ...
    if(a->_tag == Result__String_String_Success_tag) {
        Result__String_String* _6_temp = a;
        String* x = &_6_temp->u.Success.member0;
        // Case expr:
        bool _23;
        if(b->_tag == Result__String_String_Error_tag) {
            Result__String_String* _11_temp = b;
            String* wildcard_13 = &_11_temp->u.Error.member0;
            // Case expr:
            _23 = false;
        }
        else if(b->_tag == Result__String_String_Success_tag) {
            Result__String_String* _11_temp = b;
            String* y = &_11_temp->u.Success.member0;
            // Case expr:
            bool _22 = String__EQ_(x, y);
            _23 = _22;
        }
        else UNHANDLED("Result.carp", 147);
        _41 = _23;
    }
    else if(a->_tag == Result__String_String_Error_tag) {
        Result__String_String* _6_temp = a;
        String* x = &_6_temp->u.Error.member0;
        // Case expr:
        bool _40;
        if(b->_tag == Result__String_String_Success_tag) {
            Result__String_String* _28_temp = b;
            String* wildcard_30 = &_28_temp->u.Success.member0;
            // Case expr:
            _40 = false;
        }
        else if(b->_tag == Result__String_String_Error_tag) {
            Result__String_String* _28_temp = b;
...
Result__ZLibZBytes_String Result_Error__String_ZLibZBytes(String member0) {
  Result__ZLibZBytes_String instance;
    instance.u.Error.member0 = member0;
    instance._tag = Result__ZLibZBytes_String_Error_tag;
    return instance;
}
...
Result__ZLibZBytes_String Result_Success__ZLibZBytes_String(ZLibZBytes member0) {
  Result__ZLibZBytes_String instance;
    instance.u.Success.member0 = member0;
    instance._tag = Result__ZLibZBytes_String_Success_tag;
    return instance;
}
...
void Result_delete__ZLibZBytes_String(Result__ZLibZBytes_String p) {
  if(p._tag == Result__ZLibZBytes_String_Success_tag) {
    /* Ignore non-managed member 'u.Success.member0' : ZLib.ZBytes */
  }
  else if(p._tag == Result__ZLibZBytes_String_Error_tag) {
    String_delete(p.u.Error.member0);
  }
...
String Result_str__String_String(Result__String_String *p) {
  ...
  temp = String_prn(&p->u.Success.member0); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  }
  if(p->_tag == Result__String_String_Error_tag) {
...
bool Result_success_QMARK___String_String(Result__String_String* a) {
    bool _14;
    if(a->_tag == Result__String_String_Error_tag) {
        Result__String_String* _5_temp = a;
        String* wildcard_7 = &_5_temp->u.Error.member0;
        // Case expr:
        _14 = false;
    }
    else if(a->_tag == Result__String_String_Success_tag) {
        Result__String_String* _5_temp = a;
        String* wildcard_11 = &_5_temp->u.Success.member0;
        // Case expr:
        _14 = true;
    }
...
bool Result_success_QMARK___ZLibZBytes_String(Result__ZLibZBytes_String* a) {
    bool _14;
    if(a->_tag == Result__ZLibZBytes_String_Error_tag) {
        Result__ZLibZBytes_String* _5_temp = a;
        String* wildcard_7 = &_5_temp->u.Error.member0;
        // Case expr:
        _14 = false;
    }
    else if(a->_tag == Result__ZLibZBytes_String_Success_tag) {
        Result__ZLibZBytes_String* _5_temp = a;
        ZLibZBytes* wildcard_11 = &_5_temp->u.Success.member0;
        // Case expr:
        _14 = true;
    }
    else UNHANDLED("Result.carp", 90);
...
ZLibZBytes Result_unsafe_MINUS_from_MINUS_success__ZLibZBytes_String(Result__ZLibZBytes_String a) {
    ZLibZBytes _10;
    if(a._tag == Result__ZLibZBytes_String_Success_tag) {
        Result__ZLibZBytes_String _5_temp = a;
        ZLibZBytes x = _5_temp.u.Success.member0;
        // Case expr:
        _10 = x;
    }
    else UNHANDLED("Result.carp", 58);
...
TestState Test_assert_MINUS_equal__Result__String_String_MUL__String(TestState* state, Result__String_String* x, Result__String_String* y, String* descr) {
    ...
    String *_12_ref = &_12;
    Lambda _13 = { .callback = (void*)Result__EQ___String_String, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Result.=__String_String (LookupGlobal CarpLand AFunction)
    TestState _14 = Test_handler__Result__String_String_MUL__Result__String_String_MUL__String_String(state, x, y, descr, _12_ref, _13);
    return _14;
}
...
TestState Test_display_MINUS_test__Result__String_String_MUL__Result__String_String_MUL__String_String(TestState* state, Result__String_String* expected, Result__String_String* actual, String* descr, String* what, bool is_MINUS_success) {
    ...
    if (is_MINUS_success) {
        ...
        IO_print(_131);
        String _137 = Result_str__String_String(expected);
        ...
        String _158 = Result_str__String_String(actual);
...
TestState Test_handler__Result__String_String_MUL__Result__String_String_MUL__String_String(TestState* state, Result__String_String* expected, Result__String_String* actual, String* descr, String* what, Lambda op) {
    bool _18 = op.env ? ((bool(*)(LambdaEnv, Result__String_String*, Result__String_String*))op.callback)(op.env, expected, actual) : ((bool(*)(Result__String_String*, Result__String_String*))op.callback)(expected, actual);
    TestState _19 = Test_display_MINUS_test__Result__String_String_MUL__Result__String_String_MUL__String_String(state, expected, actual, descr, what, _18);
    Function_delete__Result__String_String_MUL__Result__String_String_MUL__bool(op);
    return _19;
}
...
String* ZLib_ZBytes_bytes(ZLibZBytes* p) { return (&(p->bytes)); }
...
int* ZLib_ZBytes_len(ZLibZBytes* p) { return (&(p->len)); }
...
String ZLib_ZBytes_prn(ZLibZBytes *p) {
  ...
  int tempsize = 0;
  (void)tempsize; // that way we remove the occasional unused warning 
  int size = snprintf(NULL, 0, "(%s )", "ZLib.ZBytes");
  temp = Int_prn(p->len); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  temp = String_prn(&p->bytes); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "ZLib.ZBytes");
  temp = Int_prn(p->len);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
...
ZLibZBytes ZLib_ZBytes_update_MINUS_bytes(ZLibZBytes p, Lambda *updater) {
    p.bytes = (*updater).env ? ((Fn__LambdaEnv_String_String)(*updater).callback)((*updater).env, p.bytes) : ((Fn__String_String)(*updater).callback)(p.bytes);
    return p;
}
...
ZLibZLevel ZLib_ZLevel_BestCompression() {
  ZLibZLevel instance;
    ...
    instance._tag = ZLibZLevel_BestCompression_tag;
    return instance;
}
...
ZLibZLevel ZLib_ZLevel_BestSpeed() {
  ZLibZLevel instance;
    ...
    instance._tag = ZLibZLevel_BestSpeed_tag;
    return instance;
}
...
ZLibZLevel ZLib_ZLevel_DefaultCompression() {
  ZLibZLevel instance;
    ...
    instance._tag = ZLibZLevel_DefaultCompression_tag;
    return instance;
}
...
ZLibZLevel ZLib_ZLevel_NoCompression() {
  ZLibZLevel instance;
    ...
    instance._tag = ZLibZLevel_NoCompression_tag;
    return instance;
}

ZLibZLevel ZLib_ZLevel_copy(ZLibZLevel* pRef) {
    ZLibZLevel copy = *pRef;
    if(pRef->_tag == ZLibZLevel_NoCompression_tag) {

    }

    else if(pRef->_tag == ZLibZLevel_BestSpeed_tag) {

    }

    else if(pRef->_tag == ZLibZLevel_BestCompression_tag) {

    }

    else if(pRef->_tag == ZLibZLevel_DefaultCompression_tag) {
...
void ZLib_ZLevel_delete(ZLibZLevel p) {
  if(p._tag == ZLibZLevel_NoCompression_tag) {

  }
  else if(p._tag == ZLibZLevel_BestSpeed_tag) {

  }
  else if(p._tag == ZLibZLevel_BestCompression_tag) {

  }
  else if(p._tag == ZLibZLevel_DefaultCompression_tag) {

  }

}

int ZLib_ZLevel_get_MINUS_tag(ZLibZLevel *p) { return p->_tag; }
String ZLib_ZLevel_prn(ZLibZLevel *p) {
  // convert members to String here:
  String temp = NULL;
  int tempsize = 0;
  ...
  int size = 1;
  if(p->_tag == ZLibZLevel_NoCompression_tag) {
    size += snprintf(NULL, 0, "(%s ", "NoCompression");

  }
  if(p->_tag == ZLibZLevel_BestSpeed_tag) {
    size += snprintf(NULL, 0, "(%s ", "BestSpeed");

  }
  if(p->_tag == ZLibZLevel_BestCompression_tag) {
    size += snprintf(NULL, 0, "(%s ", "BestCompression");

  }
  if(p->_tag == ZLibZLevel_DefaultCompression_tag) {
    size += snprintf(NULL, 0, "(%s ", "DefaultCompression");
  ...
  if(p->_tag == ZLibZLevel_NoCompression_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "NoCompression");

    bufferPtr--;
    snprintf(bufferPtr, size - (bufferPtr - buffer), ")");
  }
  if(p->_tag == ZLibZLevel_BestSpeed_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "BestSpeed");

    bufferPtr--;
    snprintf(bufferPtr, size - (bufferPtr - buffer), ")");
  }
  if(p->_tag == ZLibZLevel_BestCompression_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "BestCompression");

    bufferPtr--;
    snprintf(bufferPtr, size - (bufferPtr - buffer), ")");
  }
  if(p->_tag == ZLibZLevel_DefaultCompression_tag) {
    bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "DefaultCompression");
...
int ZLib_ZLevel_to_MINUS_int(ZLibZLevel l) {
    int _18;
    if(l._tag == ZLibZLevel_NoCompression_tag) {
        ZLibZLevel _5_temp = l;
        // Case expr:
        _18 = 0;
    }
    else if(l._tag == ZLibZLevel_BestSpeed_tag) {
        ZLibZLevel _5_temp = l;
        // Case expr:
        _18 = 1;
    }
    else if(l._tag == ZLibZLevel_BestCompression_tag) {
        ZLibZLevel _5_temp = l;
        // Case expr:
        _18 = 9;
    }
    else if(l._tag == ZLibZLevel_DefaultCompression_tag) {
        ZLibZLevel _5_temp = l;
        // Case expr:
        _18 = -1;
    }
    else UNHANDLED("zlib.carp", 62);
    return _18;
}

Result__ZLibZBytes_String ZLib_deflate(String* s) {
    ZLibZLevel _7 = ZLib_ZLevel_DefaultCompression();
    Result__ZLibZBytes_String _8 = ZLib_deflate_MINUS_with(s, _7);
    return _8;
}

Result__ZLibZBytes_String ZLib_deflate_MINUS_with(String* s, ZLibZLevel level) {
    Result__ZLibZBytes_String _35;
    /* let */ {
        int _11 = ZLib_ZLevel_to_MINUS_int(level);
        ZRes _12 = ZLib_deflate_c(s, _11);
        ZRes r = _12;
        Result__ZLibZBytes_String _34;
        ZRes* _18 = &r; // ref
        bool _19 = ZRes_is_ok(_18);
        if (_19) {
            ZLibZBytes _24 = ZRes_bytes(r);
            Result__ZLibZBytes_String _25 = Result_Success__ZLibZBytes_String(_24);
            Result__ZLibZBytes_String _26 = _25;
            _34 = _26;
        } else {
            String _31 = ZRes_err(r);
            Result__ZLibZBytes_String _32 = Result_Error__String_ZLibZBytes(_31);
            Result__ZLibZBytes_String _33 = _32;
            _34 = _33;
        }
        _35 = _34;
    }
...
Result__String_String ZLib_inflate(ZLibZBytes s) {
    ...
    /* let */ {
        ZRes _8 = ZLib_inflate_c(s);
        ZRes r = _8;
        Result__String_String _30;
        ZRes* _14 = &r; // ref
        bool _15 = ZRes_is_ok(_14);
        if (_15) {
            String _20 = ZRes_str(r);
            Result__String_String _21 = Result_Success__String_String(_20);
            Result__String_String _22 = _21;
            _30 = _22;
        } else {
            String _27 = ZRes_err(r);
            Result__String_String _28 = Result_Error__String_String(_27);
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        static String _21 = "hi";
        String *_21_ref = &_21;
        Result__ZLibZBytes_String _22 = ZLib_deflate(_21_ref);
        Result__ZLibZBytes_String* _23 = &_22; // ref
        bool _24 = Result_success_QMARK___ZLibZBytes_String(_23);
        static String _25 = "deflation returns success";
        String *_25_ref = &_25;
        TestState _26 = Test_assert_MINUS_true__String(test, _24, _25_ref);
        TestState* _1000011 = &_26; // ref
        test = _1000011;  // (Ref Test.State r91) = (Ref Test.State r91)
        static String _39 = "hi";
        String *_39_ref = &_39;
        Result__ZLibZBytes_String _40 = ZLib_deflate(_39_ref);
        ZLibZBytes _41 = Result_unsafe_MINUS_from_MINUS_success__ZLibZBytes_String(_40);
        Result__String_String _42 = ZLib_inflate(_41);
        Result__String_String* _43 = &_42; // ref
        bool _44 = Result_success_QMARK___String_String(_43);
        static String _45 = "deflation->inflation returns success";
        String *_45_ref = &_45;
        TestState _46 = Test_assert_MINUS_true__String(test, _44, _45_ref);
        TestState* _1000014 = &_46; // ref
        test = _1000014;  // (Ref Test.State r91) = (Ref Test.State r91)
        static String _57 = "Data Error";
        String *_57_ref = &_57;
        String _58 = String_copy(_57_ref);
        Result__String_String _59 = Result_Error__String_String(_58);
        Result__String_String* _60 = &_59; // ref
        static String _66 = "hi";
        String *_66_ref = &_66;
        String _67 = String_copy(_66_ref);
        ZLibZBytes _68 = ZLib_ZBytes_init(3, _67);
        Result__String_String _69 = ZLib_inflate(_68);
        Result__String_String* _70 = &_69; // ref
        static String _71 = "inflating random data returns data error";
        String *_71_ref = &_71;
        TestState _72 = Test_assert_MINUS_equal__Result__String_String_MUL__String(test, _60, _70, _71_ref);
        TestState* _1000017 = &_72; // ref
        test = _1000017;  // (Ref Test.State r91) = (Ref Test.State r91)
        static String _84 = "hi";
        String *_84_ref = &_84;
        Result__ZLibZBytes_String _85 = ZLib_deflate(_84_ref);
        ZLibZBytes _86 = Result_unsafe_MINUS_from_MINUS_success__ZLibZBytes_String(_85);
        Result__String_String _87 = ZLib_inflate(_86);
        bool _99;
        if(_87._tag == Result__String_String_Success_tag) {
            Result__String_String _87_temp = _87;
            String s = _87_temp.u.Success.member0;
            // Case expr:
            String* _94 = &s; // ref
            static String _95 = "hi";
            String *_95_ref = &_95;
            bool _96 = String_starts_MINUS_with_QMARK_(_94, _95_ref);
            _99 = _96;
            String_delete(s);
        }
        else if(true) {
            Result__String_String _87_temp = _87;
            Result__String_String wildcard_97 = _87_temp;
            _99 = false;
            Result_delete__String_String(wildcard_97);
        }
        else UNHANDLED("zlib.carp", 19);
        static String _100 = "deflation->inflation preserves payload prefix";
        String *_100_ref = &_100;
        TestState _101 = Test_assert_MINUS_true__String(test, _99, _100_ref);
        TestState* _1000020 = &_101; // ref
        test = _1000020;  // (Ref Test.State r91) = (Ref Test.State r91)
        Test_print_MINUS_test_MINUS_results(test);
        int* _1000024 = Test_State_failed(test);
        int _1000023 = Int_copy(_1000024);
        int _1000007 = _1000023;
        _1000003 = _1000007;
        Result_delete__String_String(_42);
        Result_delete__String_String(_59);
        Result_delete__String_String(_69);
        Result_delete__ZLibZBytes_String(_22);
        Test_State_delete(_1000006);
        Test_State_delete(_101);
        Test_State_delete(_26);
        Test_State_delete(_46);
        Test_State_delete(_72);
    }
    return _1000003;
}
